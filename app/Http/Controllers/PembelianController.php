...
class PembelianController extends Controller
{
    ...
    public function data()
    {
        ...
        ->addColumn('total_item', function ($pembelian) {
            return format_rupiah($pembelian->total_item);
        })
        ->addColumn('total_harga', function ($pembelian) {
            return 'Rp. '.format_rupiah($pembelian->total_harga);
        })
        ->addColumn('bayar', function ($pembelian) {
            return 'Rp. '.format_rupiah($pembelian->bayar);
        })
        ->addColumn('created_at', function ($pembelian) {
            return format_tanggal_indonesia($pembelian->created_at);
        })
        ...
        ->addColumn('aksi', function ($pembelian) {
            return '
                <button onclick="viewData(`' . route('pembelian.show', $pembelian->id_pembelian) . '`)" class="btn btn-xs btn-warning btn-flat"><i class="fa fa-eye"></i></button>
    ...
    public function show($id)
    {
        ...
        ->addColumn('harga_beli', function ($detail) {
            return 'Rp. '.format_rupiah($detail->produk->harga_beli);
        })
